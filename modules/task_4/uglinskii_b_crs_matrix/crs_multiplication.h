...
#ifndef MODULES_TASK_4_UGLINSKII_B_CRS_MATRIX_CRS_MULTIPLICATION_H_
#define MODULES_TASK_4_UGLINSKII_B_CRS_MATRIX_CRS_MULTIPLICATION_H_
...
int CRSMultiplySTD(MatrixCRS A, MatrixCRS B, MatrixCRS *C);

#endif  // MODULES_TASK_4_UGLINSKII_B_CRS_MATRIX_CRS_MULTIPLICATION_H_