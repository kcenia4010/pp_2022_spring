...
#include "../../../modules/task_4/uglinskii_b_crs_matrix/crs_multiplication.h"
...
int CRSMultiplySTD(MatrixCRS A, MatrixCRS B, MatrixCRS *C) {
  ...
  int lenght = A.N / threads_num;
  int remainder = A.N % threads_num;

  int local_begin = 0, local_end = 0;
